...
- Inline links: when writing a neuron that references something you've already
  read in another neuron, link to it. Example: a project neuron mentions "SIT"
  and you already read `infrastructure/environments.md` which defines SIT --
  write `[SIT](../../infrastructure/environments.md)` instead of plain "SIT".
  Use your reading context, not exhaustive scanning.
